...
public class ResponseBuilder {
     ...
     */
    public static AIResponse tellResponse(String message) {
        AIResponse rootResponse = new AIResponse();
        rootResponse.speech = message;
        rootResponse.displayText = message;
        return rootResponse;
    }
     ...
     */
    public static AIResponse askResponse(String message) {
     ...
     * @return {@link RootResponse} object that uses speech response to ask user for additional data
     */
    public static AIResponse askResponse(String message, String[] noInputPrompts) {
     ...
     * @return {@link RootResponse} object that uses speech response to ask user for additional data
     */
    public static AIResponse askResponse(String message, String conversationToken, String[] noInputPrompts) {
        AIResponse rootResponse = new AIResponse();
        rootResponse.speech = message;
        rootResponse.displayText = message;
        return rootResponse;
     ...
     */
    public static AIResponse askForPermissionResponse(String permissionContext, SupportedPermissions... permissions) {
     ...
     *                                  thrown when any of given permission isn't one of: [NAME, DEVICE_PRECISE_LOCATION, DEVICE_COARSE_LOCATION]
     */
    public static AIResponse askForPermissionResponse(String permissionContext, String... permissions) {
     ...
     *                                  thrown when any of given permission isn't one of: [NAME, DEVICE_PRECISE_LOCATION, DEVICE_COARSE_LOCATION]
     */
    public static AIResponse askForPermissionResponse(String permissionContext, Collection<String> permissions) throws IllegalArgumentException {
        ...
        try {
 		...
 		AIResponse rootResponse = new AIResponse();
        rootResponse.speech = permissionContext;
        rootResponse.displayText = permissionContext;
        return rootResponse;
        /*if (permissionContext == null || permissionContext.length() == 0) {
            throw new IllegalArgumentException("permissionContext argument cannot be null");
        }
