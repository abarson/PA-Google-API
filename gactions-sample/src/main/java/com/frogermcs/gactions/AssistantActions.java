...
import com.frogermcs.gactions.sample.RouteRequestHandlerFactory;
...
public class AssistantActions {
     ...
     */
    public void handleRequest(AIRequest aiRequest) {
        ...
        String actionIntent = AssistantUtils.getActionIntent(aiRequest);
        //RequestHandler requestHandler = requestHandlersFactories.get("com.example.route_intent").create(aiRequest);
        RequestHandler requestHandler = requestHandlersFactories.get(actionIntent).create(aiRequest);
        ...
        /*if (actionIntent != null && requestHandlersFactories.containsKey(actionIntent)) {
            RequestHandler requestHandler = requestHandlersFactories.get("com.example.route_intent").create(rootRequest);
            //RequestHandler requestHandler = RouteRequestHandlerFactory.create(rootRequest);
            responseHandler.onResponse(requestHandler.getResponse());
            //responseHandler.onResponse("This intent is: " + actionIntent);
        } else {
